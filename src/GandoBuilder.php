...
/**
 * GandoBuilder is used to configure and build an instance of the SDK.
 */
class GandoBuilder
{
    ...
    public function setRetryConfig(Retry\RetryConfig $config): GandoBuilder
    {
    ...
    public function build(): Gando
    {
        ...
        return new Gando($this->sdkConfig);
    }
}